package entities.sound.music 
{
	 ...
	 * @author James Keats
	 */
	public class Song4Sfx extends MySfx 
	{
		
		public function Song4Sfx(myPlatformIDs:Vector.<Vector.<int>>, complete:Function=null, type:String=null) 
		{
			super(C.SONG_4, complete, type);
